...
\begin{itemize}
  ...
  \item Live measurement on an 8-worker Jetson fleet across
        \emph{28} operating points on OPT-350M (two chain lengths
        $\times$ four architecture variants $\times$ three--four
        concurrency levels) plus a 3$\times$-larger-model
        sub-matrix on Llama-3.2-1B, showing latency-optimal
