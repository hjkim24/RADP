...
6-worker Jetson fleet (plus an AGX Xavier coordinator), Nano CPU
is $\sim$76$\times$ slower per
layer than Nano CUDA, and AGX Orin MAXN is $1.36\times$ faster than
Nano CUDA at OPT-350M seq=64 forward --- the CUDA-vs-CPU gap
dominates and is what makes placement decisions structurally
sensitive (\S\ref{sec:eval:setup}).  Second,
