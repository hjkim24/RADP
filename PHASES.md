...
스윕 유효 측정치: **full_replay 5/5 완주** — P=4/8/16/24/32 = 3.08/4.64/8.06/11.74/15.36 s, fit **1.17 s + 440.7 ms/pos**
(350M 0.31 s + 164 ms/pos의 2.7×; P=4/8 중복 측정 3.200/4.679 s와 4% 이내 일치), reference 36 tok 결정론 재확인.
...
- 2026-09-08 교수 피드백: Discussion 절을 본문으로 흡수(§IV-B Reconfigure 설명·SpotServe 대비, §IV-C 패리티 vs 복제 선택·이중 실패 해석, §IV-E 결합 해석), §V를 'Conclusion and Future Work'로 통합. 10쪽.
- 2026-09-13 교수 최종 피드백 9항목 반영: 초록 244단어, footprint를 primary-path 정의로 재정의(3.7× 유지), Table I Reconfigure 행 '—'+각주, KiB/MiB/GiB 표기, §III-E에 backup solver(greedy, device order, free−self−reserved, transfer+recompute 최소, first-tie) 기술, P≤32 한정어(결론·초록), Reconfigure 'in minutes' 완화 + cached-profile 변형 미측정 명시, §III-B tail-stage fallback 문장, 'two failures'를 recovery latency로 명시, 미국식 철자, diagnostic study.
